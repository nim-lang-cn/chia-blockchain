...
class Wallet:
    ...
    async def hack_populate_secret_keys_for_coin_solutions(self, coin_solutions: List[CoinSpend]) -> None:
        """
    ...
    async def sign_transaction(self, coin_solutions: List[CoinSpend]) -> SpendBundle:
